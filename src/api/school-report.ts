...
export function useGetBookingReports(
  ...
  const getTheFullUrl = () => {
    ...
    return `${endpoints.schoolReportSessionPreview.booking}?${new URLSearchParams(queryParams)}`;
  };
...
export function useGetTrainerReports(
  ...
  const getTheFullUrl = () => {
    ...
    return `${endpoints.schoolReportSessionPreview.trainer}?${new URLSearchParams(queryParams)}`;
  };
...
export function useGetSchoolReports(
  ...
  const getTheFullUrl = () => {
    ...
    return `${endpoints.schoolReportSessionPreview.school}?${new URLSearchParams(queryParams)}`;
  };
