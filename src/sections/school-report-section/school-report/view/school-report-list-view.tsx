...
import { useGetSchoolReports } from 'src/api/school-report';
...
export default function SchoolReportListSchoolAdminView() {
  ...
  const handleDownloadClick = async () => {
    try {
      ...
      const response = await fetch(`${baseUrl}admin/reportBySchool/school?${queryParams}`, {
        method: 'GET',
        headers: {
          Accept: 'text/csv',
