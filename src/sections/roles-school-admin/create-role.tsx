...
import { createRole } from 'src/api/roles-and-permission';
import { useSnackbar } from 'src/components/snackbar';
import { createRoleBySchoolAdmin } from 'src/api/role-permission-school-admin';

const CreateRole = ({ onClose, reload }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    try {
      ...
      if (validate()) {
        ...
        const response = await createRoleBySchoolAdmin(createData);
